...
## Requirements
Gem depends on `active_record >= 3`. We test it with `rails-3.0`, `rails-3.1`, `rails-3.2`, `rails-4.0` and with `ruby-1.9.3`, `jruby-1.6.7` and `rubinius-2.0` (sorry, support for ruby 1.9.2 and 1.8.7 is dropped).
